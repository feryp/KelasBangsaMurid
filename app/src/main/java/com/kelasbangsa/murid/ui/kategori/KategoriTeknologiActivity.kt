...
class KategoriTeknologiActivity : AppCompatActivity(), OnItemClickListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kategori_teknologi)
        ...
        bidangStudi.add(BidangStudi(R.drawable.im_tek_graph_design,"Desain Grafis"))
        bidangStudi.add(BidangStudi(R.drawable.im_tek_adobe,"Adobe"))
        bidangStudi.add(BidangStudi(R.drawable.im_tek_mic_office,"Ms. Office"))
