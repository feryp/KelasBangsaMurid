package com.kelasbangsa.murid.ui.home
...
import com.kelasbangsa.murid.ui.notification.NotificationActivity
...
class HomeFragment : Fragment(), ItemClickListener, View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when(v.id){
            R.id.btn_notification ->{
                val notifikasi = Intent(activity, NotificationActivity::class.java)
